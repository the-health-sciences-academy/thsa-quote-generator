<div class="thsa_qg_email_settings">
        ...
        <br/>
        <p>
            <input type="button" class="button button-primary button-large thsa_save_gen_ettings" value="<?php esc_html_e('Save', 'thsa-quote-generator') ?>"> <span class="thsa_qg_response"><?php esc_html_e('Changes has been save','thsa-quote-generator'); ?></span>
        </p>
