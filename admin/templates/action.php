<div class="thsa_qg_wrapper">
    <div class="thsa_qg_inner thsa_qg_action">
        ...
        <p>
            <a href="javascript:void(0);" class="button button-secondary widefat thsa_qg_manage_email_content"><?php esc_html_e('Manage Email Content','thsa-quote-generator'); ?></a>
        </p>
        <?php else: ?>
...
<div class="thsa_qg_manage_content">
    <div class="thsa_qg_manage_content_content">
        ...
        <div class="thsa_qg_manage_content_content_footer">
            <input type="button" data-id="<?php esc_html_e($params['id'],'thsa-quote-generator'); ?>" class="button button-primary" id="thsa_qg_manage_content_last" value="<?php esc_html_e('Save','thsa-quote-generator'); ?>"> <input type="button" class="button button-secondary" id="thsa_qg_close_manage_content" value="<?php esc_html_e('Close','thsa-quote-generator'); ?>"> <span class="thsa_qg_response thsa_qg_manange_email_con"><?php esc_html_e('Changes has been saved', 'thsa-quote-generator'); ?></span>
        </div>
    </div>
</div>