    ...
    <div class="thsa_qg_inner">
        ...
        <div class="thsa_qg_table_con">
            ...
            <table border="0" class="thsa_qg_discount_table1">
                <tr>
                    <td>
                        <select class="thsa_qg_payment_type widefat">
                    ...
                    <td>
                        <label><input type="checkbox" name="allow_payment_type" checked value="Y"> <?php _e('not allow changing Payment Type', 'thsa-quote-generator'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        <div class="thsa_qg_table_con">
            ...
            <table border="0" class="thsa_qg_discount_table2">
                <tr>
                    <td valign="middle">
                        <input type="number" class="widefat thsa_qg_fix_amount" placeholder="Fix discount">
                    </td>
                    <td valign="middle">
                        <label><input type="number" class="thsa_qg_percent_amount" placeholder="Percentage discount"><span class="thsa_qg_tail_text">%</span></label>
                    </td>
                    <td valign="middle">
                        <table class="thsa_qg_wide thsa_qg_plan_fields" border="0">
                            <tr>
                                ...
                                <td>
                                    <select class="thsa_qg_plan_term">
                                ...
                                <td>
                                    <label><input type="checkbox" name="allow_term_edit" checked value="Y"> <?php _e('Do not allow term edit', 'thsa-quote-generator'); ?></label>
                                </td>
                            </tr>
                        </table>
                    </td>
